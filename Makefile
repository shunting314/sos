...
kernel: kernel/entry.s kernel/kernel.ld
	...
	$(CXX) -c kernel/simfs.cpp $(CFLAGS) -o out/kernel/simfs.o
	...
	$(LD) out/kernel/entry.o out/kernel/asm_util.o out/kernel/kernel_main.o out/kernel/vga.o out/kernel/stdio.o out/kernel/idt.o out/kernel/keyboard.o out/kernel/user_process.o out/kernel/tss.o out/kernel/ide.o out/kernel/kshell.o out/kernel/simfs.o out/kernel/paging.o out/kernel/phys_page.o out/kernel/syscall.o out/kernel/interrupt_entry.o out/lib/string.o -T kernel/kernel.ld -o out/kernel/kernel
