...
KERNEL_SRC_CPP := $(wildcard kernel/*.cpp) $(wildcard kernel/nic/*.cpp) $(wildcard kernel/net/*.cpp) $(wildcard kernel/usb/*.cpp) $(wildcard kernel/wifi/*.cpp) $(wildcard kernel/wifi/legacy/*.cpp)
